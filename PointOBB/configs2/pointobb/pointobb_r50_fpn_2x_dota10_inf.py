...
data_root_trainval = '/home/shardul.junagade/my-work/domain-adaptation-brick-kilns/PointOBB/DOTAv10/data/split_ss_dota_1024_200/val'
data_root_test = '/home/shardul.junagade/my-work/domain-adaptation-brick-kilns/PointOBB/DOTAv10/data/split_ss_dota_1024_200/val'
...
data = dict(
    ...
    train=dict(
        ...
        ann_file = data_root_trainval + "val_1024_P2Bfmt_dotav10_rbox.json",
...
# Inference
# load_from = '../TOV_mmdetection_cache/work_dir/dota/epoch_22.pth'
...
evaluation = dict(
    save_result_file='xxx/work_dir_epoch_23/test_pointobb_r50_fpn_2x_dota/pseudo_obb_result.json',
    do_first_eval=True
)
runner = dict(type='EpochBasedRunner', max_epochs=0)